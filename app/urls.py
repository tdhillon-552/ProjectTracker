...
urlpatterns = [
    ...
    path('customer/external/details/<uuid:external_uuid>/', CustomerExternalDetails.as_view(),
         name='customerexternaldetails'),
    path('customer/external/details/<uuid:external_uuid>/print/', CustomerExternalDetailsPrintPDF.as_view(),
